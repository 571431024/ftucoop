          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form class="form-horizontal" enctype="multipart/form-data" method="post"
                action="../sql_function/sql_edit_student_bio_admin.php">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <input type="text" class="form-control"
                        value="<?php echo $row['tb_prefix_name']; ?> <?php echo $row['tb_std_name']; ?> " disabled>
                    </div>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form class="form-horizontal" enctype="multipart/form-data" method="post"
                            ...
                            <input type="hidden" name="tb_std_fathername"
                              value="<?php echo $row['tb_std_fathername']; ?>">
                            <input type="hidden" name="tb_std_fatheroccu"
                              value="<?php echo $row['tb_std_fatheroccu']; ?>">
                            <input type="hidden" name="tb_std_fatherocculo"
                              value="<?php echo $row['tb_std_fatherocculo']; ?>">
                            <input type="hidden" name="tb_std_fathertel"
                              value="<?php echo $row['tb_std_fathertel']; ?>">
                            <input type="hidden" name="tb_std_mothername"
                              value="<?php echo $row['tb_std_mothername']; ?>">
                            <input type="hidden" name="tb_std_motheroccu"
                              value="<?php echo $row['tb_std_motheroccu']; ?>">
                            <input type="hidden" name="tb_std_motherocculo"
                              value="<?php echo $row['tb_std_motherocculo']; ?>">
                            <input type="hidden" name="tb_std_mothertel"
                              value="<?php echo $row['tb_std_mothertel']; ?>">
                  ...
                  ?>
                      ...
                      ?>
                              ...
                              <label class="control-label col-md-2">ชื่อ</label>
                              <div class="col-md-3">
                                <input type="text" class="form-control" id="tb_std_name" name="tb_std_name"
                                  value="<?php echo $row['tb_std_name']; ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <label class="control-label col-md-2">รหัสนักศึกษา</label>
                              <div class="col-md-3">
                                <input readonly type="text" class="form-control" id="tb_std_identification"
                                  name="tb_std_identification" value="<?php echo $row['tb_std_identification']; ?>">
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-3">
                                <input type="text" class="form-control" id="tb_std_gpa" name="tb_std_gpa"
                                  value="<?php echo $row['tb_std_year']; ?>">
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-3">
                                <input class="form-control" type="text" id="tb_std_tall" name="tb_std_tall"
                                  value="<?php echo $row['tb_std_tall']; ?>">
                              </div>
                              <label class="control-label col-md-2">น้ำหนัก</label>
                              <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-3">
                                <input type="text" class="form-control" id="tb_std_nationality"
                                  name="tb_std_nationality" value="<?php echo $row['tb_std_nationality']; ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-2">ศาสนา</label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <textarea class="form-control" rows="5" name="tb_std_address" disabled> <?php echo $row['tb_std_address']; ?></textarea>
                    </div>
                  </div>
                        ...
                        <div class="modal-body">
                          <form class="form-horizontal" enctype="multipart/form-data" method="post"
                            ...
                            <div class="form-group">
                              <label class="control-label col-md-2">เลขที่</label>
                              <div class="col-md-3">
                                <input type="text" class="form-control" name="tb_std_homeno"
                                  value="<?php echo $row['tb_std_homeno']; ?> ">
                              </div>
                              <label class="control-label col-md-2">ตรอก/ซอย</label>
                              <div class="col-md-3">
                                <input class="form-control" name="tb_std_soi"
                                  value="<?php echo $row['tb_std_soi']; ?> ">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-3">
                                <input class="form-control" name="tb_std_rode"
                                  value="<?php echo $row['tb_std_rode']; ?> ">
                              </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-3">
                                <input type="text" class="form-control" name="tb_std_post"
                                  value="<?php echo $row['tb_std_post']; ?> ">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-8">
                                <textarea class="form-control" rows="5" name="tb_std_address"> <?php echo $row['tb_std_address']; ?></textarea>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <label class="control-label col-md-2">โทรศัพท์</label>
                              <div class="col-md-3">
                                <input class="form-control" name="tb_std_tel"
                                  value="<?php echo $row['tb_std_tel']; ?> ">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-4">
                                <input type="email" class="form-control" name="tb_std_email"
                                  value="<?php echo $row['tb_std_email']; ?> ">
                              </div>
                            </div>
                  ...
                  <legend>4.ข้อมูลเกี่ยวกับครอบครัว <div align="right"> <button type="button"
                        class="btn btn-info btn-xs" data-toggle="modal" data-target="#editHis3">
                        <i class="glyphicon glyphicon-edit"></i> Edit</button></div>
                  </legend>
                  <div class="form-group">
                        ...
                        <div class="modal-body">
                          <form class="form-horizontal" enctype="multipart/form-data" method="post"
                            ...
                            <div class="form-group">
                              <label class="control-label col-md-2">ชื่อ-สกุลบิดา</label>
                              <div class="col-md-4">
                                <input type="text" class="form-control" name="tb_std_fathername"
                                  value="<?php echo $row['tb_std_fathername']; ?> ">
                              </div>
                              <label class="control-label col-md-2">อาชีพ</label>
                              <div class="col-md-3">
                                <input class="form-control" name="tb_std_fatheroccu"
                                  value="<?php echo $row['tb_std_fatheroccu']; ?> ">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <label class="control-label col-md-2">สถานที่ทำงาน</label>
                              <div class="col-md-4">
                                <input type="text" class="form-control" name="tb_std_fatherocculo"
                                  value="<?php echo $row['tb_std_fatherocculo']; ?> ">
                              </div>
                              <label class="control-label col-md-2">เบอร์โทรติดต่อ</label>
                              <div class="col-md-3">
                                <input class="form-control" name="tb_std_fathertel"
                                  value="<?php echo $row['tb_std_fathertel']; ?> ">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <label class="control-label col-md-2">ชื่อ-สกุลมารดา</label>
                              <div class="col-md-4">
                                <input type="text" class="form-control" name="tb_std_mothername"
                                  value="<?php echo $row['tb_std_mothername']; ?> ">
                              </div>
                              <label class="control-label col-md-2">อาชีพ</label>
                              <div class="col-md-3">
                                <input class="form-control" name="tb_std_motheroccu"
                                  value="<?php echo $row['tb_std_motheroccu']; ?> ">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <label class="control-label col-md-2">สถานที่ทำงาน</label>
                              <div class="col-md-4">
                                <input type="text" class="form-control" name="tb_std_motherocculo"
                                  value="<?php echo $row['tb_std_motherocculo']; ?> ">
                              </div>
                              <label class="control-label col-md-2">เบอร์โทรติดต่อ</label>
                              <div class="col-md-3">
                                <input class="form-control" name="tb_std_mothertel"
                                  value="<?php echo $row['tb_std_mothertel']; ?> ">
                              </div>
                            </div>
                  ...
                  <legend>5.ความสามารถทางด้านคอมพิวเตอร์ <div align="right"> <button type="button"
                        class="btn btn-info btn-xs" data-toggle="modal" data-target="#editHis4">
                        <i class="glyphicon glyphicon-edit"></i> Edit</button></div>
                  </legend>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <textarea class="form-control" rows="5" disabled> <?php echo $row['tb_std_offerlo_d']; ?>  <?php echo $row['tb_std_offerlo_d']; ?></textarea>
                    </div>
                  </div> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <a href="../student_pic/<?php  echo $studentimg ?>" target="_blank"><img
                          src="../student_pic/<?php  echo $studentimg ?>" width=140 height=160> </a>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <a href="../student_tran/<?php  echo $std_imggpa ?>" target="_blank"> <img src="../student_tran/<?php  echo $std_imggpa ?>" width=140 height=160S> </a>
                    </div>
                  </div>
                        ...
                        <div class="modal-body">
                          <form class="form-horizontal" enctype="multipart/form-data" method="post"
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-4">
                                <img src="../student_pic/<?php echo $row['tb_std_img']; ?>" width=150 height=150>
                            ...
                            <div class="form-group">
                              <label class="control-label col-md-2">Transcript</label>
                              <div class="col-md-4">
                                <img src="../student_tran/<?php echo $row['tb_std_imggpa']; ?>" width=150 height=150>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <input type="text" class="form-control"
                        value="<?php echo $row['tb_mentor_name']; ?> <?php echo $row['tb_mentor_lastname']; ?>  "
                        disabled>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <input type="text" class="form-control"
                        value="<?php echo $row['tb_ads_name']; ?> <?php echo $row['tb_ads_lastname']; ?> " disabled>
                    </div>
                  </div>
                  ...
                  <?php
                    ...
                    $txt = $pdf->conv("ศูนย์สหกิจศึกษาและฝึกประสบการณ์วิชาชีพ มหาวิทยาลัยฟาฏอนี");
                    $pdf->Cell(0, 0, $txt, 0, 1, 'C');
                    $pdf->SetFont('AngsanaNew', '', 17);
                    $pdf->Ln(8);
                    $txt = $pdf->conv("FTU Cooperative Education and Profession Training Center");
                    $pdf->Cell(0, 0, $txt, 0, 1, 'C');
                    $pdf->Ln(20);
                    ...
                    $pdf->Image("../student_pic/$stdpre_imgpro", 170, 18, 25);
                    $pdf->Ln(10);
                    ...
                    $pdf->Output("../admin/MyPDF/$stdpre_id.pdf","F");

                    ?>

                  <a class="pull-right" href="../admin/MyPDF/<?php echo $stdpre_id ?>.pdf" target="_blank"><img
                      src="../student_pic/printer1.png" width="80" height="80"></a>
