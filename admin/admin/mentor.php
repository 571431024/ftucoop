...
?>
                <div class="row">
                    <div class="col-lg-12">
                        <button type="button" class="btn btn-success pull-left" data-toggle="modal" data-target="#add_mentor"><i
                                class="glyphicon glyphicon-plus"></i> เพิ่มพี่เลี้ยง</button>
                    </div>
                </div>
                <!--/.row -->
                <br />
                        ...
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_mentor">
                                ...
                                <tbody>
									...
									WHERE (tb_mentor_name LIKE '%".$keyword."%') ";
