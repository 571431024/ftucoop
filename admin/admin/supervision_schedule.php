...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="supervision_schedule.php"><em class="fa fa-calendar">&nbsp;</em> จัดการตารางนิเทศ</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
include ("../admin/add_supervision_schedule.php");
?>
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_supervision_schedule">
                                <thead>
                                    <tr>
                                        <th>
                                            <center>ลำดับ</center>
                                ...
                                <tbody>
                                    ...
                                    WHERE ( tb_ads_name LIKE '%".$keyword."%') ";
    ...
    <script>
        $(document).ready(function () {
            $('#table_supervision_schedule').DataTable();
