        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    Admin <small>Control panel</small>
                </h1>
                <div class=" panel-container">
                    <div class="row">
                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                            <div class="panel panel-teal panel-widget border-right">
                                <div class="row no-padding"><em style="color: #;" class="fa fa-5x fa-users"></em>
                                    <div class="">จัดการข้อมูลคณะบดี</div><br>
                                    <div class="text-muted"> <a href="department.php">View</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                            <div class="panel panel-teal panel-widget border-right">
                                <div class="row no-padding"><em style="color: #008080;" class="fa fa-5x fa-users"></em>
                                    <div class="">จัดการข้อมูลอาจารย์ประจำสาขา</div><br>
                                    <div class="text-muted"> <a href="department.php">View</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                            <div class="panel panel-blue panel-widget border-right">
                                <div class="row no-padding"><em style="color: #1874CD;" class="fa fa-5x fa-users"></em>
                                    <div class="">จัดการข้อมูลอาจารย์ที่ปรึกษา</div><br>
                        ...
                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                            <div class="panel panel-blue panel-widget border-right">
                                <div class="row no-padding"><em style="color: #6f42c1;" class="fa fa-5x fa-users"></em>
                                    <div class="">จัดการข้อมูลนักศึกษา</div><br>
                ...
                <div class=" panel-container">
                    <div class="row">
                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                            <div class="panel panel-info panel-widget border-right">
                                <div class="row no-padding"><em style="color: #e83e8c;" class="fa fa-5x fa-users "></em>
                                    <div class="">จัดการข้อมูลพี่เลี้ยง</div><br>
                        ...
                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                            <div class="panel panel-teal panel-widget border-right">
                                <div class="row no-padding"><em style="color:#EE0000;" class="fa fa-5x fa-map-marker "></em>
                                    <div class="">จัดการข้อมูลสถานที่</div><br>
                        ...
                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                            <div class="panel panel-blue panel-widget border-right">
                                <div class="row no-padding"><em style="color: #FF3300;" class="fa fa-5x fa-file-text color-teal"></em>
                        ...
                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                            <div class="panel panel-blue panel-widget border-right">
                                <div class="row no-padding"><em style="color: #FF6600;" class="fa fa-5x fa-calendar"></em>
                                    <div class="">จัดการตารางนิเทศ</div><br>
                    ...
                    <div class=" panel-container">
                        <div class="row">
                            <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                                <div class="panel panel-blue panel-widget border-right">
                                    <div class="row no-padding"><em style="color: #FF9900;" class="fa fa-5x fa-calendar-check-o"></em>
                                        <div class="">บันทึกการเข้าฝึกประจำวัน</div><br>
                            ...
                            <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                                <div class="panel panel-teal panel-widget border-right">
                                    <div class="row no-padding"><em style="color: #FFD700;" class="fa fa-5x fa-bar-chart"></em>
                                        <div class="">ผลการประเมิณนักศึกษา</div><br>
