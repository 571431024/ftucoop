    ...
    <div class="container marketing">
      <div class="panel-group">
        <div class="panel panel-default">
          ...
          <ol class="breadcrumb">
            <li class="active">
              <i class="fa fa-lightbulb-o fa-2x"></i>  รายละเอียด
            </li>
          </ol>
          <div class="panel-body">
            ...
            <?php
                                    ...
                                    if(empty($submit))
                                    {
                                        ...
                                        {
                                        $tb_act_id = $result_row[0];
                                        $tb_act_title = $result_row[1];
                                        $tb_act_description = $result_row[2];
                                        $tb_act_date = $result_row[3];
                                        $tb_act_img= $result_row[4];
                                        $tb_act_file = $result_row[5];
                                    ...
                                    else
                                    {
                                        ...
                                        $tb_act_date=$_POST['tb_act_date'];
                                        $tb_act_img=$_POST['tb_act_img'];
                                        $tb_act_file=$_POST['tb_act_file'];
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <?php echo $tb_act_description ?>
                  </td>
                </tr>
                <tr>
                  <th align="right" scope="row">&nbsp;</th>
                  <th>รูป</th>
                  <td> <img src="../../img_frontweb/<?php  echo $tb_act_img ?>" width=200 height=160></td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <?php if($tb_act_file != ""){ ?>
                    <a href=../../file_frontweb/ <?php echo $tb_act_file ?> target="_blank"> <button class="btn btn-info btn-xs">
                        <i class="glyphicon glyphicon-cloud-download"> ดาวน์โหลด
                          <?php echo $tb_act_file ?> </i></button></a>
                    <?php }else{?>
                    <a href="#"> <button class="btn btn-danger btn-xs">
                        <i class="glyphicon glyphicon-remove"> ไม่มีไฟล์แนบ </i></button></a>
                    <?php } ?>
                  </td>
                </tr>
                </tr>
      ...
      <!-- FOOTER -->
      <!-- <footer>
    <a class="pull-right" href="#"> <button class="btn btn-info btn-xs"><i class="fa fa-arrow-circle-up fa-2x"></i>
