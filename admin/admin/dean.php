...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
                <em class="fa fa-bullhorn">&nbsp;</em> จักการข้อมูลหน้าเว็บ <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
                </a>
            ...
            <li class="active"><a href="dean.php"><em class="fa fa-users">&nbsp;</em> จัดการข้อมูลคณะบดี</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            จัดการ <small>ข้อมูลคณะบดี</small>
                        </h1>
                    </div>
                </div>
                <br>
                ...
                <?php
    include ("../admin/add_dean.php");
    ?>
                <div class="row">
                    <div class="col-lg-12">
                        <button type="button" class="btn btn-success pull-left" data-toggle="modal" data-target="#add_dean"><i
                                class="glyphicon glyphicon-plus"></i> เพิ่มคณะบดี</button>
                    </div>
                </div>
                <!--/.row -->
                <br />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table  class="display responsive no-wrap" width="100%" id="table_dean">
                                <thead>
                                    <tr>
                                        <th>
                                            <center>ลำดับ</center>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT td_dean.tb_dean_id, 
                                        td_dean.tb_dean_id_log, td_dean.tb_dean_password, 
                                        td_dean.tb_dean_name, td_dean.tb_dean_lastname,td_dean.tb_dean_faculty,
                                        td_dean.tb_dean_email, td_dean.tb_dean_tel,td_dean.tb_prefix_tb_prefix_id,
                                        tb_prefix.tb_prefix_name FROM td_dean 

                                        INNER JOIN tb_prefix ON td_dean.tb_prefix_tb_prefix_id =tb_prefix.tb_prefix_id
                                        INNER JOIN tb_faculty ON td_dean.tb_dean_faculty =tb_faculty.tb_faculty_name
                                        
                                        WHERE (tb_dean_name LIKE '%".$keyword."%') ";
                                         ...
                                         $rs = mysql_query($sql) or die(mysql_error());
                                                    ...
                                                    $sql .=" ORDER BY tb_dean_id ASC LIMIT $Page_Start , $Per_Page";
                                                    $rs  = mysql_query($sql);
                                                    $i = 1;
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <?php echo $row['tb_dean_id_log']; ?>
                                        </td>
                                        <td align="center">
                                            <?php echo $row['tb_prefix_name']; ?>
                                            <?php echo $row['tb_dean_name']; ?>
                                        </td>
                                        <td align="center">
                                            <?php echo $row['tb_dean_lastname']; ?>
                                        </td>
                                        <td align="center">
                                            <?php echo $row['tb_dean_faculty']; ?>
                                        </td>
                                        <td align="center">
                                            <?php echo $row['tb_dean_email']; ?>
                                        </td>
                                        <td align="center">
                                            <?php echo $row['tb_dean_tel']; ?>
                                        </td>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-edit"></i>
                                                                แก้ไขข้อมูลคณะบดี</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form class="form-horizontal" method="post" action="../sql_function/sql_edit_dean.php">
                                                                <input type="hidden" name="tb_dean_id" value="<?php echo $row['tb_dean_id']; ?>">
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-2">รหัสบุคลากร</label>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="tb_dean_id_log"
                                                                            name="tb_dean_id_log" value="<?php echo $row['tb_dean_id_log']; ?>">
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <input type="password" class="form-control" id="tb_dean_password"
                                                                            name="tb_dean_password" value="<?php echo $row['tb_dean_password']; ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="tb_dean_name"
                                                                            name="tb_dean_name" value="<?php echo $row['tb_dean_name']; ?>">
                                                                    </div>
                                                                    <label class="control-label col-md-2">นามสกุล</label>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="tb_dean_lastname"
                                                                            name="tb_dean_lastname" value="<?php echo $row['tb_dean_lastname']; ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <select class="form-control" id="tb_dean_faculty"
                                                                            name="tb_dean_faculty">
                                                                    ...
                                                                    ?>
                                                                            <option value="<?php echo $rowm['tb_faculty_name']; ?>"
                                                                                <?php if($rowm['tb_faculty_name']==$row['tb_dean_faculty']){
                                                                                echo "selected" ; } ?>>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <input type="email" class="form-control" id="tb_dean_email"
                                                                            name="tb_dean_email" value="<?php echo $row['tb_dean_email']; ?>">
                                                                    </div>
                                                                    <label class="control-label col-md-2">เบอร์โทรศัพท์</label>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="tb_dean_tel"
                                                                            name="tb_dean_tel" value="<?php echo $row['tb_dean_tel']; ?>">
                                                                    </div>
                                                                </div>
                                        ...
                                        <td>
                                            <center><a href="../sql_function/sql_delete_dean.php?flag= <?=$row['tb_dean_id']; ?>"
    ...
    <script>
        $(document).ready(function () {
            $('#table_dean').DataTable();

        });
    </script>

    <!-- <script src="add_dean.js"></script> -->
