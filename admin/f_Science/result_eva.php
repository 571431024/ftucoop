...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_evaluateResult">
                                <thead>
                                    <tr>
                                        <th>
                                            <center>ลำดับ</center>
                                        ...
                                        <th>
                                            <center>ประเมินจากอาจารย์</center>
                                        </th>
                                        <th>
                                            <center>ประเมินจากพี่เลี้ยง</center>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    WHERE  tb_advisor.tb_ads_faculty = '$faculty' AND (tb_std_name LIKE '%".$keyword."%')";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id= '$row[tb_std_id]'";
                                            ...
                                            <center> <a href="../f_Science/view_advisor_eva.php?flag= <?=$row['tb_std_id']; ?>">
                                                    <button class="btn btn-info btn-xs">
                                                        <i class="glyphicon glyphicon-eye-open"> ดูผลการประเมิน</i></button></a>
                                            </center>
                                            <?php } else {?>
                                            <center> <a href="#"> <button class="btn btn-danger btn-xs">
                                                        <i class="glyphicon glyphicon-warning-sign"> ยังไม่ได้ประเมิน
                                                        </i></button></a> </center>
                                            <?php } ?>
                                        </td>
                                        <td>
                                            ...
                                            $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE  tb_student_tb_std_id= '$row[tb_std_id]'";
                                            $query_eva=mysql_query($sql_eva);
                                            $rows=mysql_num_rows($query_eva);

                                            if ($rows>=1    ) {?>
                                            <center> <a href="../f_Science/view_mentor_eva.php?flag= <?=$row['tb_std_id']; ?>">
                                                    <button class="btn btn-info btn-xs">
                                                        <i class="glyphicon glyphicon-eye-open"> ดูผลการประเมิน</i></button></a>
                                            </center>
                                            <?php } else {?>
    ...
    <script>
        $(document).ready(function () {
            $('#table_evaluateResult').DataTable();
