...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li><a href="student_come.php"><em class="fa fa-calendar-check-o">&nbsp;</em>
                    ดูการเข้าฝึกประจำวันนักศึกษา</a></li>
            <li class="active"><a href="result_eva.php"><em class="fa fa-bar-chart">&nbsp;</em> ดูผลการประเมิณนักศึกษา</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-check"></i> รายละเอียดผลการประเมินจาก #อาจารย์ที่ปรึกษา
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='1'";
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='2'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i2 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='3'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i3 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='4'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i4 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='5'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i5 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='6'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i6 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='7'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i7 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='8'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i8 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='9'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i9 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='10'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i10 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='11'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i11 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='12'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i12 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='13'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i13 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='14'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i14 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='15'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i15 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='16'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i16 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='17'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i17 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='18'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i18 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='19'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i19 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='20'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i20 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='21'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i21 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='cmm'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='22'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i22 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='23'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i23 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='24'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i24 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='25'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i25 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='26'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i26 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='27'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i27 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='28'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i28 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='29'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i29 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='30'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i30 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE std_id='$tb_std_id' AND eva_no='31'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i31 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='32'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i32 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='33'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i33 = $rows['score'];
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE  std_id='$tb_std_id' AND eva_no='34'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        $i34 = $rows['score'];
