...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="student_come.php"><em class="fa fa-calendar-check-o">&nbsp;</em> ดูการเข้าฝึกประจำวันนักศึกษา</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-user"></i> รายละเอียดการเข้าฝึกประจำวันนักศึกษา
                            </li>
                        </ol>
                    </div>
                </div>
