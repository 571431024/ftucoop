    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Evaluate Result</li>
            </ol>
        </div>
        <!--/.row-->
       ...
       $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='1'";
        ...
        ?>
         ...
         $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='2'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='3'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='4'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='5'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='6'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='7'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        ?>
         ...
         $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='8'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='9'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='10'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='11'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='12'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='13'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        ?>
         ...
         $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='14'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='15'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='16'";
        $query_eva=mysql_query($sql_eva);
        $rows=mysql_fetch_array($query_eva);
        ...
        ?>
                        ...
                        <tr>
                            <?php
            $sqlScore="SELECT  sum(tb_evm_score) as sumScore FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND  tb_student_tb_std_id= '$tb_std_id'";
          ...
          ?>
                        ...
                        <tr>
                            <?php
            $sqlScore="SELECT  sum(tb_evm_score)*100/80 as sumScore FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND  tb_student_tb_std_id= '$tb_std_id'";
            $queryScore=mysql_query($sqlScore);
            $rwScore = mysql_fetch_array($queryScore);
                                        ...
                                        <td colspan="2">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <?php
                   include ("../../../sql_function/connect.php");
                    $sql_eva="SELECT  * FROM tb_evaluation_mentor WHERE tb_mentor_tb_mentor_id ='$id' AND tb_student_tb_std_id='$tb_std_id' AND tb_evm_no='tb_ev'";
                    $query_eva=mysql_query($sql_eva);
                    $rows=mysql_fetch_array($query_eva);
                  ?>
