...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="student_come.php"><em class="fa fa-file-text">&nbsp;</em>
                    บันทึกการมาฝึกวิชาชีพรายวัน</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Check Student</li>
            </ol>
        </div>
        <!--/.row-->
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            บันทึก <small>การมาฝึกวิชาชีพนักศึกษา</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-save"></i> บันทึกการมาฝึกวิชาชีพนักศึกษา
                            </li>
                        </ol>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-bell"></i> คำชี้แจง </br> ให้พี่เลี้ยงเลือกกดปุ่มบันทึกการมา การขาด
                                และการลา ของนักศึกษา </br>
                                โดยแต่ละวันจะกดได้แค่วันละ 1 ครั้งเท่านั้นโดยเลือกปุ่มใดปุ่มหนึ่ง </br>ตลอดเวลาทำการของสถานประกอบการณ์
                                ในขณะที่นักศึกษาได้ดำเนินการฝึกวิชาชีพ ณ สถานที่นั้นๆ
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_studentCome">
                                <thead>
                                    <tr>
                                        <th>
                                            <center>ลำดับ</center>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center> <a href="../../../sql_function/sql_check_come.php?flag= <?=$row['tb_std_id']; ?>">
                                                    <button class="btn btn-success btn-xs">
                                                        <i class="glyphicon glyphicon-check"> เช็คการมา</i></button></a>
                                            </center>
                                        </td>
                                        <td>
                                            <center> <a href="../../../sql_function/sql_check_miss.php?flag= <?=$row['tb_std_id']; ?>">
                                                    <button class="btn btn-danger btn-xs">
                                                        <i class="glyphicon glyphicon-check"> เช็คการขาด</i></button></a>
                                            </center>
                                        </td>
                                        <td>
                                            <center> <a href="../../../sql_function/sql_check_leave.php?flag= <?=$row['tb_std_id']; ?>">
                                                    <button class="btn btn-warning btn-xs">
                                                        <i class="glyphicon glyphicon-check"> เช็คการลา</i></button></a>
                                            </center>
                                        </td>
                                        <td>
                                            <center> <a href="student_come_detail.php?flag= <?=$row['tb_std_id']; ?>">
                                                    <button class="btn btn-info btn-xs">
                                                        <i class="glyphicon glyphicon-eye-open">สรุปการบันทึก</i></button></a>
                                            </center>
                                        </td>
                                    </tr>
                                    <?php
