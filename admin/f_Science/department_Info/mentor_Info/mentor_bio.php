...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="mentor_bio.php"><em class="fa fa-user">&nbsp;</em>Manage Profile</a></li>
    ...
    <div class="col-sm-10 col-sm-offset-3 col-md-10 col-md-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                <li><a href="#">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <?php
                            ...
                            $sql = "SELECT tb_mentor.*, tb_prefix.*, tb_prefix.*, tb_localtion.*
                                    FROM tb_prefix 
                                    LEFT JOIN tb_mentor ON tb_prefix.tb_prefix_id = tb_mentor.tb_prefix_tb_prefix_id 
                                    LEFT JOIN tb_localtion ON tb_localtion.tb_lo_id = tb_mentor.tb_localtion_tb_lo_id 
                                    
                                    WHERE tb_mentor.tb_mentor_id = '$id'";
                            $result = mysql_query($sql) or die (mysql_error());
                            $row = mysql_fetch_array($result);
                            
                            $preID = $row['tb_prefix_tb_prefix_id'];
                            $mentorimg = $row['tb_mentor_img'];
                            $locationID = $row['tb_localtion_tb_lo_id'];
                        ...
                        <div class="container">
                            <div class="jumbotron">
                                <div class="row">
                                    <div class="col-md-10 col-sm-10 col-lg-2">
                                        <div class="thumbnail text-center photo_view_postion_b">
                                            <?php if($mentorimg == ""){ ?>
                                            <img src="../../picture/no_image.gif" />
                                            <?php }else{?>
                                            <img src="../../../picture/<?php  echo $row['tb_mentor_img'];?>" alt="stack photo"
                                                class="img">
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-8 col-sm-6 col-lg-8">
                                        ...
                                        <br>
                                        <div class="col-md-8 col-sm-6 col-lg-10">
                                            <p><span class="fa fa-google" style="width:50px;"></span>
                                                <a href="mailto:<?php echo $row['tb_mentor_email']; ?>">
                                                    <?php echo $row['tb_mentor_email']; ?></a></p>
                                        ...
                                        <div class="col-md-10 col-sm-10 col-lg-10">
                                            <p><span class="fa fa-building" style="width:50px;"></span>
                            ...
                            <div class="modal fade" id="editHis" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                ...
                                <div class="modal-dialog modal-lg">
                                    ...
                                    ?>
                                            ...
                                            ?>
                                                            <option value="<?php echo $row2['tb_prefix_id']; ?>" <?php
                                                                if($preID==$row2['tb_prefix_id']){ echo "selected" ; }
                                                                ?>>
                                            ...
                                            ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" id="tb_mentor_tel" name="tb_mentor_tel"
                                                            value="<?php echo $row['tb_mentor_tel']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                           ...
                                           include ("../../../sql_function/connect.php");
                                            ...
                                            ?>
                                                            <option value="<?php echo $row3['tb_lo_id']; ?>" <?php
                                                                if($locationID==$row3['tb_lo_id']){ echo "selected" ; }
                                                                ?>>
                                                                <?php echo $row3['tb_lo_name']; ?>
                                                            </option>
                                                            <?php
                                            }
                                            //mysql_close();
                                            ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <img src="../../../picture/<?php echo $mentorimg ?>" width=150
                                                            height=150>

                                                        <input type="file" class="form-control" name="fileUpload" id="fileUpload">
                                                        <br>
                                                        <input type="hidden" class="form-control" name="hdnOldFile"
                                                            value="<?php echo $mentorimg ?>">
                                                    </div>
                                                </div>
