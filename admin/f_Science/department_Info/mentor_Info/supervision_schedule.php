    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Supervisory</li>
            </ol>
        </div>
        <!--/.row-->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ข้อมูล <small>ตารางนิเทศ</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-list-alt"></i> ตารางนิเทศอาจารย์
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form class="form-inline pull-right" method="POST" onsubmit="return checkTeaSearch()" action="#">
                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_suprervision">
                                <thead>
                                    <tr>
                                        <th>
                                            <center>ลำดับ</center>
