    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div id="page-wrapper">
            ...
            <!-- Page Heading -->
                ...
                <?php
                    include ("../department_Info/add_document.php");
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <button type="button" class="btn btn-success pull-left" data-toggle="modal"
                            data-target="#add_document"><i class="glyphicon glyphicon-plus"></i> เพิ่มเอกสาร</button>
                    </div>
                </div>
                <!--/.row -->
                <br />
                            ...
                            <table class="display responsive no-wrap" width="100%" id="table_document">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="form-horizontal" enctype="multipart/form-data"
                                                                method="post"
                                                                action="../../sql_function/sql_edit_document.php">
                                                                <input type="hidden" name="tb_doc_id"
                                                                    value="<?php echo $row['tb_doc_id']; ?>">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label col-md-2">ชื่อเอกสาร</label>
                                                                    <div class="col-md-3">
                                                                        <input type="text" class="form-control"
                                                                            id="tb_doc_name" name="tb_doc_name"
                                                                            value="<?php echo $row['tb_doc_name']; ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <textarea type="text" rows="4"
                                                                            class="form-control" id="tb_doc_des"
                                                                            name="tb_doc_des"> <?php echo $row['tb_doc_des']; ?> </textarea>
                                                                    </div>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label col-md-2">ไฟล์อัพโหลด</label>
                                                                    <div class="col-md-4">
                                                                        <?php echo $row['fileUpload']; ?>
                                                                        <input type="file" class="form-control"
                                                                            name="fileUpload" id="fileUpload"> <br>
                                                                    </div>
                                                                </div>
                                                        </div><!-- /.row-->
                                        ...
                                        <td>
                                            <center><a
                                                    href="../../sql_function/sql_delete_document.php?flag= <?=$row['tb_doc_id']; ?>"
