...
?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_resultEva">
                                <thead>
                                    <tr>
        ...
        if ($rows>=1    ) {?>
                                            ...
                                            <center> <a href="../department_Info/view_advisor_eva.php?flag= <?=$row['tb_std_id']; ?>">
        ...
        if ($rows>=1    ) {?>
                                            ...
                                            <center> <a href="../department_Info/view_mentor_eva.php?flag= <?=$row['tb_std_id']; ?>">
                                                    <button class="btn btn-info btn-xs">
                                                        <i class="glyphicon glyphicon-eye-open"> ดูผลการประเมิน</i></button></a>
                                            </center>
