                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            จัดการ <small>ข้อมูลนักศึกษา</small>
                        </h1>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="form-inline pull-right" method="post" onsubmit="return checkTeaSearch()" action="<?php echo $_SERVER['SCRIPT_NAME'];?>">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="keyword" name="keyword" placeholder="ระบุชื่อ เพื่อค้นหา...">
                                <button class="btn btn-lg btn-primary" type="submit"> <i class="glyphicon glyphicon-search"></i>
                                    ค้นหา</button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_student">
                                <thead>
                                    <tr>
                                        <th>
                                            <center>ลำดับ</center>
                                ...
                                <tbody>
                                    ...
                                    LEFT JOIN tb_localtion ON tb_student.tb_localtion_tb_lo_id = tb_localtion.tb_lo_id
                                    LEFT JOIN tb_student_status ON tb_student.tb_std_status_id = tb_student_status.tb_sta_id
                                    WHERE tb_student.tb_std_major = '$major' AND (tb_std_name LIKE '%".$keyword."%') ";
                                    // แยกสาขา
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($status == '1')  
                                                ...
                                                echo '<center>   <button class="btn btn-success btn-xs">  
                                                                        <i class="glyphicon glyphicon-ok-circle"> อนุมัติแล้ว(Approval) </i></button></center>';
                                                }else if($status == '2') {
                                        ...
                                        <td align="center">
                                            <center><a href="../department_Info/student_bio.php?flag= <?=$row['tb_std_id']; ?> ">
                                        ...
                                        <td>
                                            <center>
                                                <button type="button" class="btn btn-warning btn-xs" data-toggle="modal"
                                                    data-target="#editstudent<?php echo $i; ?>">
                                                    <i class="glyphicon glyphicon-check"></i> สถานะ</button></center>
                                            <!-- Modal -->
                                            <div class="modal fade" id="editstudent<?php echo $i; ?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="form-horizontal" method="post" enctype="multipart/form-data"
                                                                action="../../sql_function/sql_edit_student_status.php">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        <select class="form-control" id="tb_mentor_id"
                                                                            ...
                                                                            WHERE major_id = '".$_SESSION['major_id']."'";
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        <select class="form-control" id="tb_ads_id"
                                                                            name="tb_ads_id">
                                                                            <option value="no">-เลือกอาจารย์ที่ปรึกษา-</option>
                                                                            <?php

                                                                          
                                                                            $sqlm = "SELECT * FROM tb_advisor
                                                                            WHERE tb_ads_major = '".$_SESSION['major']."'";
                                                                            $rsm = mysql_query($sqlm) or die(mysql_error());
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        <select class="form-control" id="tb_sta_id"
                                                                            name="tb_sta_id">
                                                                            <option value="no">-เลือกสถานะนักศึกษา-</option>
                                                                            <?php

                                                                          
                                                                            $sqlm = "SELECT * FROM tb_student_status";
                                                                            $rsm = mysql_query($sqlm) or die(mysql_error());

                                                                            while($rowm = mysql_fetch_array($rsm)){
                                                                            ?>
                                                                            <option value="<?php echo $rowm['tb_sta_id']; ?>"
                                                                                <?php if($rowm['tb_sta_id']==$row['tb_std_status_id']){
                                                                                echo "selected" ; } ?>>
                                                                                <?php echo $rowm['tb_sta_name'] ?>
                                                                            </option>
                                                                            <?php
                                                                            }
                                                                            //mysql_close();
                                        ...
                                        <td>
                                            <center><a href="../../sql_function/sql_delete_student.php?flag= <?=$row['tb_std_id']; ?> "
