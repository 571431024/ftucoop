...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li><a href="#"><em class="fa fa-users">&nbsp;</em> จัดการข้อมูลอาจารย์ประจำสาขา</a></li>
    ...
    ?>
                <div class="row">
                    <div class="col-lg-12">
                        <button type="button" class="btn btn-lg btn-success pull-left" data-toggle="modal" data-target="#add_department"><i
                                class="glyphicon glyphicon-plus"></i> เพิ่มอาจารย์</button>
                        <form class="form-inline pull-right" method="post" onsubmit="return checkTeaSearch()" action="<?php echo $_SERVER['SCRIPT_NAME'];?>">
                            <div class="form-group">

                                <input type="text" class="form-control" id="keyword" name="keyword" onKeyUp="clear_input();"
                                    placeholder="ระบุชื่อ เพื่อค้นหา...">
                                <button class="btn btn-lg btn-primary" type="submit" name="button1" id="button1" value="Search">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        tb_department.tb_dept_name, tb_department.tb_dept_lastname, 
                                    ...
                                    <tr>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="form-horizontal" method="post" action="../sql_function/sql_edit_department.php">
                                                                <input type="hidden" name="tb_dept_id" value="<?php echo $row['tb_dept_id']; ?>">
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-2">รหัสบุคลากร</label>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="tb_dept_id_log"
                                        ...
                                        <td>
                                            <center><a href="../sql_function/sql_delete_advisor.php?flag= <?=$row['tb_dept_id']; ?>"
