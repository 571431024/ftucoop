...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="mentor.php"><em class="fa fa-users">&nbsp;</em> ดูข้อมูลพี่เลี้ยง
                    <!-- &amp; --></a></li>
                        ...
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_mentor">
                                ...
                                <tbody>
									...
									WHERE tb_mentor.faculty_id='$faculty_id' AND (tb_mentor_name LIKE '%" . $keyword . "%') ";
                                    ...
                                    while ($row = mysql_fetch_array($rs)) {
                                        ...
                                        <tr>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <select class="form-control" id="tb_prefix_id" name="tb_prefix_id">
                                                                                ...
                                                                                while ($rowm = mysql_fetch_array($rsm)) {
                                                                                    ?>
                                                                                    <option value="<?php echo $rowm['tb_prefix_id']; ?>" <?php if ($rowm['tb_prefix_id'] == $row['tb_prefix_tb_prefix_id']) {
                                                                                                                                                echo "selected";
                                                                                                                                            } ?>>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-5">
                                                                            <select class="form-control" id="tb_lo_id" name="tb_lo_id">
                                                                                ...
                                                                                while ($rowm = mysql_fetch_array($rsm)) {
                                                                                    ?>
                                                                                    <option value="<?php echo $rowm['tb_lo_id']; ?>" <?php if ($rowm['tb_lo_id'] == $row['tb_localtion_tb_lo_id']) {
                                                                                                                                            echo "selected";
                                                                                                                                        } ?>>
                                            ...
                                            <!-- <td align="center"><a href="../../sql_function/sql_delete_mentor.php?flag= <?php echo $row['tb_mentor_id']; ?>"
