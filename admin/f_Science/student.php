...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="student.php"><em class="fa fa-users">&nbsp;</em> ดูข้อมูลนักศึกษา</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
                include("../f_Science/add_student.php");
                ?>
                <br />
                <!-- Panel for table -->
                <div class="row">
                            ...
                            <table class="display responsive no-wrap" width="100%" id="table_student">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <center>อาจารย์ที่ปรึกษา</center>
                                        </th>
                                        <th>
                                ...
                                <tbody>
                                    ...
                                    WHERE  tb_student.td_std_faculty = '$faculty' AND (tb_std_name LIKE '%" . $keyword . "%') ";
                                    // แยกสาขา
                                    ...
                                    while ($row = mysql_fetch_array($rs)) {
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <center><a href="../f_Science/student_bio.php?flag= <?= $row['tb_std_id']; ?> ">
