    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li><a href="mentor.php"><em class="fa fa-users">&nbsp;</em> ดูข้อมูลพี่เลี้ยง
                    <!-- &amp; --></a></li>
            <li class="active"><a href="location.php"><em class="fa fa-map-marker">&nbsp;</em> ดูข้อมูลสถานที่</a></li>
                        ...
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_location">
                                ...
                                <tbody>
                                    ...
                                    WHERE tb_localtion.faculty_id='$faculty_id' AND ( tb_lo_name LIKE '%".$keyword."%') ";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center><a href="../f_Science/location_detail.php?flag= <?=$row['tb_lo_id']; ?> ">
