...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="dean_bio.php"><em class="fa fa-user">&nbsp;</em> Manage Profile</a></li>
                ...
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            $sql = "SELECT td_dean.*, tb_prefix.*
                                    FROM tb_prefix 
                                    LEFT JOIN  td_dean ON tb_prefix.tb_prefix_id =  td_dean.tb_prefix_tb_prefix_id 
                                    
                                    WHERE  td_dean.tb_dean_id = '$id'";
                            $result = mysql_query($sql) or die (mysql_error());
                            $row = mysql_fetch_array($result);
                            
                            $preID = $row['tb_prefix_tb_prefix_id'];
                            $deanimg = $row['tb_dean_img'];
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-xs-12 col-sm-6 col-lg-3">
                                            <div class="thumbnail text-center photo_view_postion_b">
                                                ...
                                                <?php }else{?>
                                                <img src="../picture/<?php  echo $row['tb_dean_img'];?>" alt="stack photo"
                                                    class="img">
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <div class="col-md-9 col-xs-12 col-sm-6 col-lg-9">
                                            ...
                                            <div class="col-md-8 col-xs-12 col-sm-6 col-lg-9">
                                                <p><span class="fa fa-google" style="width:50px;"></span>
                                                    <a href="mailto:<?php echo $row['tb_dean_email']; ?>">
                                                        <?php echo $row['tb_dean_email']; ?></a></p>
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal" enctype="multipart/form-data" method="post"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input readonly type="text" class="form-control" id="tb_dean_faculty"
                                                                name="tb_dean_faculty" value="<?php echo $row['tb_dean_faculty']; ?>">
                                                        </div>
                                                    </div>
                            ...
                            ?>
                                ...
                                ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <img src="../picture/<?php echo $deanimg ?>" width=140
                                                                height=160>

                                                            <input type="file" class="form-control" name="fileUpload"
                                                                id="fileUpload"> <br>
                                                            <input type="hidden" class="form-control" name="hdnOldFile"
                                                                value="<?php echo $deanimg ?>">
