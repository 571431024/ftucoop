...
$sql = "UPDATE  tb_department SET tb_dept_id = '$tb_dept_id', tb_dept_id_log = '$tb_dept_id_log', 
tb_dept_password = '$tb_dept_password' ,tb_prefix_tb_prefix_id  = '$tb_prefix_id', 
tb_dept_name = '$tb_dept_name', tb_dept_lastname = '$tb_dept_lastname',tb_dept_email= '$tb_dept_email',tb_dept_tel = '$tb_dept_tel' 
...
if($_FILES["fileUpload"]["name"] != "")
			...
			$sql .=" SET tb_dept_img = '".$_FILES["fileUpload"]["name"]."' WHERE tb_dept_id = '$tb_dept_id'";
			mysql_query($sql) or die ("ข้อมูลผิดพลาด".mysql_error());
