...
include ("connect.php");
	...
	$tb_std_password=$_POST['iden'];
	$td_std_faculty=$_POST['tb_std_faculty'];
	...
	$tb_std_homeno=$_POST['nohome'];
	$tb_std_soi=$_POST['soi'];
	$tb_std_rode=$_POST['rode'];
	$tb_std_province=$_POST['city'];
	$tb_std_amphur=$_POST['amphur'];
	$tb_std_tumbon=$_POST['tumbon'];
	$tb_std_post=$_POST['post'];
	...
	$tb_std_seprovince=$_POST['city1'];
	$tb_std_secate=$_POST['amphur1'];
	$tb_std_senamelo=$_POST['tumbon1'];
	...
	if($_FILES['tb_std_img']['name'] != "")
	{
			...
			// copy($_FILES['tb_std_img']['tmp_name'],"../student_pic/".$_FILES['tb_std_img']['name']);  
			//warnning
	}
 ...
 $sql = "INSERT INTO tb_student (tb_prefix_tb_prefix_id, tb_std_name,tb_std_lastname,
	tb_std_identification,tb_std_password,td_std_faculty,tb_std_major,tb_std_year,tb_std_gpa,tb_std_sex,tb_std_birthday,tb_std_tall,tb_std_weight,
	tb_std_identi,tb_std_nationality,tb_std_religion,tb_std_draft,tb_std_homeno,tb_std_soi
	,tb_std_rode,tb_std_province,tb_std_amphur,tb_std_tumbon,tb_std_post,tb_std_tel,tb_std_email,tb_std_fathername
	...
	,tb_std_ability,tb_std_workings,tb_std_seprovince

	,tb_std_secate,tb_std_senamelo,tb_std_offerlo,tb_std_offerlo_d,tb_std_offerposi,tb_student_category_tb_stdcate_id,tb_std_duration,tb_std_status_id
	,tb_std_img,tb_std_imggpa) 

VALUES('$tb_prefix_tb_prefix_id', '$tb_std_name','$tb_std_lastname','$tb_std_identification','$tb_std_password','$td_std_faculty','$tb_std_major'
,'$tb_std_year','$tb_std_gpa','$tb_std_sex','$tb_std_birthday','$tb_std_tall','$tb_std_weight'
,'$tb_std_identi','$tb_std_nationality','$tb_std_religion','$tb_std_draft'
,'$tb_std_homeno','$tb_std_soi','$tb_std_rode','$tb_std_province'
,'$tb_std_amphur','$tb_std_tumbon','$tb_std_post','$tb_std_tel'
...
,'$tb_std_mothertel','$tb_std_ability','$tb_std_workings','$tb_std_seprovince'
,'$tb_std_secate','$tb_std_senamelo','$tb_std_offerlo','$tb_std_offerlo_d','$tb_std_offerposi','$tb_stdcate_id','$tb_std_duration','$tb_std_status_id'
,'$tb_std_img', '$tb_std_imggpa' )";
