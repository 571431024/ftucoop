...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="advisor.php"><em class="fa fa-users">&nbsp;</em> จัดการข้อมูลอาจารย์ที่ปรึกษา</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
include ("../admin/add_advisor.php");
?>
                <div class="row">
                    <div class="col-lg-12">
                        <button type="button" class="btn btn-success pull-left" data-toggle="modal" data-target="#add_advisor"><i
                        ...
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_advisor">
                                ...
                                <tbody>
                                    ...
                                    INNER JOIN tb_faculty ON tb_advisor.tb_ads_faculty =tb_faculty.tb_faculty_name
                                    INNER JOIN tb_major ON tb_advisor.tb_ads_major =tb_major.tb_major_name
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    ?>
                                                                            <option value="<?php echo $rowm['tb_faculty_name']; ?>"
                                                                                <?php if($rowm['tb_faculty_name']==$row['tb_ads_faculty']){
                                                                                echo "selected" ; } ?>>
                                                                    ...
                                                                    ?>
                                                                            <option value="<?php echo $rowm['tb_major_name']; ?>"
                                                                                <?php if($rowm['tb_major_name']==$row['tb_ads_major']){
                                                                                echo "selected" ; } ?>>
    ...
    <script src="add_advisor.js"></script>
