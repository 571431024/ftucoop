...
<div class="modal fade" id="add_student_activity" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-plus"></i>
          เพิ่มข้อมูลข่าวกิจกรรมนักศึกษา</h4>
      </div>
      ...
      <div class="modal-body">
        <div class="row">
          <form class="form-horizontal" enctype="multipart/form-data" method="post"
            action="../sql_function/sql_add_student_act.php">

            <div class="form-group">
              <label class="control-label col-md-2">หัวข้อ</label>
              <div class="col-md-8">
                <input type="text" class="form-control" id="tb_act_title" name="tb_act_title" placeholder="หัวข้อ"
                  required autofocus>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <textarea type="text" rows="15" class="form-control" id="tb_act_description" name="tb_act_description"
                  placeholder="รายละเอียด" required autofocus> </textarea>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-3">
                <select class="form-control" id="tb_news_faculty" name="tb_act_faculty">
              ...
              <div class="col-md-3">
                <select class="form-control" id="tb_dept_major" name="tb_act_major">
