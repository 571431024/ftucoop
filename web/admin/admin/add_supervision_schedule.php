  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <form class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return validateAddTeacher();" action="../sql_function/sql_add_ss.php">
            ...
            <div class="form-group">
               <label class="control-label col-md-2">เวลาสิ้นสุด</label>
                <div class="col-md-3">
                <input type="time" class="form-control" id="tb_ss_timefinish" name="tb_ss_timefinish" required autofocus>
                </div>
                  </div>
               ...
               <div class="form-group">
                ...
                <div class="col-md-5">
                <?php include ("../admin/advisor_do.php"); ?>
                </div>
              </div>
