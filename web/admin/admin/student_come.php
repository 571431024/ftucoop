...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="student_come.php"><em class="fa fa-calendar-check-o">&nbsp;</em>
                    บันทึกการเข้าฝึกประจำวัน</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            บันทึก <small>การเข้าฝึกประจำวัน</small>
                        </h1>
                    </div>
                </div>
                <p> </p>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_student_come">
                                <thead>
                                    <tr>
                                        <th>
                                            <center>ลำดับ</center>
                                        ...
                                        <th>
                                            <center>สถานที่ฝึกวิชาชีพ</center>
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center> <a href="../admin/student_come_detail.php?flag= <?=$row['tb_std_id']; ?>">
