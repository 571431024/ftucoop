<!-- Modal -->
<div class="modal fade" id="add_location1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="row">
          <form class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return validateAddTeacher();" action="../sql_function/sql_add_location.php">
            ...
            <div class="form-group">
              ...
              <div class="col-md-3">  
                <input type="text" class="form-control" id="tb_lo_name" name="tb_lo_name" placeholder="ชื่อสถานที่">
              </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                  <input type="text" class="form-control" id="tb_lo_tel" name="tb_lo_tel" placeholder="เบอร์โทรศัพท์">
                </div>
                 <label class="control-label col-md-2">Email</label>
                <div class="col-md-3">
                 <input type="email" class="form-control" id="tb_lo_email" name="tb_lo_email" placeholder="กรอกอีเมลล์">
