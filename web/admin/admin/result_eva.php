...
?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="form-inline pull-right" method="POST" onsubmit="return checkTeaSearch()" action="<?php echo $_SERVER['SCRIPT_NAME'];?>">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="keyword" name="keyword" placeholder="ระบุชื่อนักศึกษา เพื่อค้นหา...">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_result_eva">
                                <thead>
                                    <tr>
        ...
        if ($rows>=1    ) {?>
                                            ...
                                            <center> <a href="../admin/view_advisor_eva.php?flag= <?=$row['tb_std_id']; ?>">
        ...
        if ($rows>=1    ) {?>
                                            ...
                                            <center> <a href="../admin/view_mentor_eva.php?flag= <?=$row['tb_std_id']; ?>">
                                                    <button class="btn btn-info btn-xs">
                                                        <i class="glyphicon glyphicon-eye-open"> ดูผลการประเมิน</i></button></a>
                                            </center>
                                            <?php } else {?>
