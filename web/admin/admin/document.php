...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li><a href="#"><em class="fa fa-users">&nbsp;</em> จัดการข้อมูลอาจารย์สาขา</a></li>
            ...
            <li class="active"><a href="document.php"><em class="fa fa-file-text">&nbsp;</em> จัดการเอกสาร</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
include ("../admin/add_document.php");
?>
                <div class="row">
                    <div class="col-lg-12">
                        <button type="button" class="btn btn-success pull-left" data-toggle="modal" data-target="#add_document"><i
                                class="glyphicon glyphicon-plus"></i> เพิ่มเอกสาร</button>
                        ...
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_document">
                                ...
                                <tbody>
                                    ...
                                    WHERE ( tb_doc_name LIKE '%".$keyword."%') ";
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <center><a href=../document/ <?php echo $row['fileUpload'];?>
                                                    target="_blank"> <button class="btn btn-info btn-xs">
                                                        <i class="glyphicon glyphicon-cloud-download"> ดาวน์โหลด</i></button></a>
                                            </center>
                                        </td>
                                        <td>
                                            <center>
                                                <button type="button" class="btn btn-warning btn-xs" data-toggle="modal"
                                                    data-target="#editdocument<?php echo $i; ?>">
                                                    <i class="glyphicon glyphicon-edit"></i> แก้ไข</button></center>

                                            <!-- Modal -->
                                            <div class="modal fade" id="editdocument<?php echo $i; ?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-edit"></i>
                                                                แก้ไขข้อมูลเอกสาร</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form class="form-horizontal" enctype="multipart/form-data"
                                                                method="post" action="../sql_function/sql_edit_document.php">
                                                                <input type="hidden" name="tb_doc_id" value="<?php echo $row['tb_doc_id']; ?>">
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-2">ชื่อเอกสาร</label>
                                                                    <div class="col-md-3">
                                                                        <input type="text" class="form-control" id="tb_doc_name"
                                                                            name="tb_doc_name" value="<?php echo $row['tb_doc_name']; ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <textarea type="text" rows="4" class="form-control"
                                                                            id="tb_doc_des" name="tb_doc_des"> <?php echo $row['tb_doc_des']; ?> </textarea>
                                                                    </div>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label class="control-label col-md-2">ไฟล์อัพโหลด</label>
                                                                    <div class="col-md-4">
                                        ...
                                        <td>
                                            <center><a href="../sql_function/sql_delete_document.php?flag= <?=$row['tb_doc_id']; ?>"
