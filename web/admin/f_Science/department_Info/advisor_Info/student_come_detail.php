    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="student_come.php"><em class="fa fa-calendar-check-o">&nbsp;</em>
                    บันทึกการเข้าฝึกประจำวัน นศ</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Student Daily Practice Detail</li>
            </ol>
        </div>
        <!--/.row-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            รายละเอียด <small>บันทึกการเข้าฝึกประจำวัน นศ.</small>
                        </h1>
                    </div>
                </div>
                <!-- /.row -->
...
?>
                                ...
                                <?php if($mentor_id == '0' || '')  
            {
             ...
             ?>
                        ...
                        <tr>
                            <?php   
        $sql ="SELECT tb_std_come FROM tb_student WHERE  tb_std_id='$tb_std_id' ";
        $query_eva=mysql_query($sql);
        $rw=mysql_fetch_array($query_eva);
        $showcome = $rw['tb_std_come'];
        ...
        ?>
                            ...
                            <td>
                                <font color="#01DF01">
                                    <?php echo  $showcome; ?> วัน</font>
                            </td>
                        </tr>
                        <tr>
                            <?php   
        $sql ="SELECT tb_std_miss FROM tb_student WHERE  tb_std_id='$tb_std_id' ";
        $query_eva=mysql_query($sql);
        $rw=mysql_fetch_array($query_eva);
        $showmiss = $rw['tb_std_miss'];
        ...
        ?>
                            ...
                            <td>
                                <font color="#FF0000">
                                    <?php echo  $showmiss; ?> วัน</font>
                            </td>
                        </tr>
                        <tr>
                            <?php   
        $sql ="SELECT tb_std_leave FROM tb_student WHERE tb_std_id='$tb_std_id' ";
        $query_eva=mysql_query($sql);
        $rw=mysql_fetch_array($query_eva);
        $showleave = $rw['tb_std_leave'];
