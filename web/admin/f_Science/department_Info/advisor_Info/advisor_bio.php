...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="advisor_bio.php"><em class="fa fa-user">&nbsp;</em>Manage Profile</a></li>
                ...
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            $sql = "SELECT tb_advisor.*, tb_prefix.*
                                    FROM tb_prefix 
                                    LEFT JOIN tb_advisor ON tb_prefix.tb_prefix_id = tb_advisor.tb_prefix_tb_prefix_id 
                                    
                                    WHERE tb_advisor.tb_ads_id = '$id'";
                            $result = mysql_query($sql) or die (mysql_error());
                            $row = mysql_fetch_array($result);
                            
                            $preID = $row['tb_prefix_tb_prefix_id'];
                            $advisorimg = $row['tb_ads_img'];
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-xs-12 col-sm-6 col-lg-3">
                                            <div class="thumbnail text-center photo_view_postion_b">
                                                ...
                                                <?php }else{?>
                                                <img src="../../../picture/<?php  echo $row['tb_ads_img'];?>" alt="stack photo"
                                                    class="img">
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <div class="col-md-9 col-xs-12 col-sm-6 col-lg-9">
                                            ...
                                            <div class="col-md-8 col-xs-12 col-sm-6 col-lg-9">
                                                <p><span class="fa fa-google" style="width:50px;"></span>
                                                    <a href="mailto:<?php echo $row['tb_ads_email']; ?>">
                                                        <?php echo $row['tb_ads_email']; ?></a></p>
                            ...
                            ?>
                                ...
                                ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <img src="../../../picture/<?php echo $advisorimg ?>" width=140
                                                                height=160>
