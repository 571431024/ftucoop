...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="supervision_schedule.php"><em class="fa fa-calendar">&nbsp;</em> ตารางนิเทศ</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Supervising teacher</li>
            </ol>
        </div>
        <!--/.row-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ตาราง <small>นิเทศอาจารย์</small>
                        </h1>
                    </div>
                </div>
                <!-- /.row -->
                        ...
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_supervision">
                                ...
                                <tbody>
                                    ...
                                    INNER JOIN tb_advisor ON tb_supervision_schedule.tb_advisor_tb_ads_id = tb_advisor.tb_ads_id 
                                    INNER JOIN tb_localtion ON tb_supervision_schedule.tb_localtion_tb_lo_id = tb_localtion.tb_lo_id   
