            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <!-- <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-check"></i> ประเมินนักศึกษา
                            </li>
                        </ol> -->
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="display responsive no-wrap" width="100%" id="table_advisorEva">
                                <thead>
                                    <tr>
                                        <th>
                                            <center>ลำดับ</center>
                                ...
                                <tbody>
                                    ...
                                    where tb_advisor_tb_ads_id='$id' AND tb_std_name LIKE '%".$keyword."%'"; 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                ...
                                                $sql_eva="SELECT  * FROM tb_evaluation_advisor WHERE adv_id ='$id' AND  std_id= '$row[tb_std_id]'";
                                                $query_eva=mysql_query($sql_eva);
                                                $rows=mysql_num_rows($query_eva);

                                                if ($rows>=1    ) {
                                            ?>
                                            <center> <a href="../advisor_Info/view_advisor_eva.php?flag= <?=$row['tb_std_id']; ?>">
                                            ...
                                            <center> <a href="../advisor_Info/advisor_eva_detail.php?flag= <?=$row['tb_std_id']; ?>">
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                <?php
                                                $allscore = 0;
                                                $sqlScore="SELECT score FROM tb_evaluation_advisor 
                                                WHERE adv_id ='$id' AND  std_id= '$row[tb_std_id]' LIMIT 22,34";
                                                
                                                $queryScore=mysql_query($sqlScore);
                                                while($rowScore = mysql_fetch_array($queryScore)){
                                                
                                                $allscore +=  $rowScore['score'];
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                <?php
                                                $allscore = 0;
                                                $sqlScore="SELECT score FROM tb_evaluation_advisor WHERE adv_id ='$id' AND  std_id= '$row[tb_std_id]' LIMIT 22,34";
                                                
                                                $queryScore=mysql_query($sqlScore);
                                                while($rowScore = mysql_fetch_array($queryScore)){

                                                
                                                $allscore +=  $rowScore['score']*100/65;
