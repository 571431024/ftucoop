      ...
      <div class="modal-body">
        <div class="row">
          <form class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return validateAddTeacher();"
            action="../../sql_function/sql_add_document.php">
            ...
            <div class="form-group">
              ...
              <div class="col-md-3">
                <input type="text" class="form-control" id="tb_doc_name" name="tb_doc_name" placeholder="ชื่อเอกสาร"
                  required autofocus>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <textarea type="text" rows="4" class="form-control" id="tb_doc_des" name="tb_doc_des" placeholder="คำอธิบาย"
