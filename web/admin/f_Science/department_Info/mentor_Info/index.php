        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    Mentor <small>Control panel</small>
                </h1>
                <div class=" panel-container">
                    <div class="row">
                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                            <div class="panel panel-teal panel-widget border-right">
                                <div class="row no-padding"><em style="color: #008080;" class="fa fa-5x fa-user"></em>
                                    <div class="">Manage Profile</div><br>
                                    <div class="text-muted"> <a href="mentor_bio.php">View</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                        ...
                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                            <div class="panel panel-blue panel-widget border-right">
                                <div class="row no-padding"><em style="color: #6f42c1;" class="fa fa-5x fa-calendar-check-o "></em>
                                    <div class="">บันทึกการมาฝึกวิชาชีพรายวัน นศ</div><br>
                        ...
                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                            <div class="panel panel-info panel-widget border-right">
                                <div class="row no-padding"><em style="color:#e83e8c;" class="fa fa-5x fa-calendar"></em>
                                    <div class="">ตารางนิเทศอาจารย์</div><br>
                ...
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                    <div class="panel panel-blue panel-widget border-right">
                        <div class="row no-padding"><em style="color:#EE0000;" class="fa fa-5x fa-bar-chart"></em>
                            <div class="">ประเมินนักศึกษา</div><br>
                            <div class="text-muted"> <a href="mentor_eva.php">View</a></div>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
