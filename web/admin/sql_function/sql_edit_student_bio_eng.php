...
include ("../sql_function/connect.php");
	...
	$tb_std_address=$_POST['tb_std_address'];  //ส่วนที่อยู่ปัจจุบัน
...
tb_std_address  = '$tb_std_address', tb_std_tel  = '$tb_std_tel' ,
...
WHERE tb_std_id = '$tb_std_id'";
	...
	echo "<script>alert('แก้ไขข้อมูลส่วนตัวเสร็จสมบูรณ์');window.location = \"../student/student_bio_eng.php\";</script>";
